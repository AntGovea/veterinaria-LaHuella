...
class ControllerClientes {
    constructor() {
        ...
        this.getDetallesPedidosByIdCliente = (req, res) => __awaiter(this, void 0, void 0, function* () {
      ...
      WHERE idUsuario=${idUsuario};`;
        ...
        this.getClientesByStatus = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
